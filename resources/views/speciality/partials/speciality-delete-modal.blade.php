...
<div class="modal fade" id="specialityDeleteModal" tabindex="-1" aria-labelledby="specialityDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header px-4 py-3">
                <h3 class="modal-title" style="color:#3bb9e7" id="specialityDeleteModalLabel">Eliminar Especialidad</h3>
